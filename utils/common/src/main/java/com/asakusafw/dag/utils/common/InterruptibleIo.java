...
public interface InterruptibleIo extends AutoCloseable {
    ...
    /**
     * {@link com.asakusafw.dag.utils.common.Action} that can throw {@link IOException} or {@link InterruptedException}.
     * @param <T> the parameter type
     */
    @FunctionalInterface
    interface IoAction<T> extends com.asakusafw.dag.utils.common.Action<T, Exception> {
