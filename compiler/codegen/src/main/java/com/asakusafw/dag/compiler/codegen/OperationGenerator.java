...
public class OperationGenerator {
    ...
    private void addConstructor(ClassWriter writer, ClassDescription target,
    ...
    private void addProcessMethod(ClassWriter writer, ClassDescription target, OperationSpec graph) {
    ...
    private void addContextField(ClassWriter writer) {
        writer.visitField(
    ...
    private void addElementFields(ClassWriter writer, ClassDescription target,
            List<VertexElement> elements, Function<VertexElement, String> ids) {
        for (VertexElement element : elements) {
            writer.visitField(
                    Opcodes.ACC_PRIVATE,
    ...
    private void getContext(MethodVisitor method, ClassDescription target, Function<VertexElement, String> ids) {
        method.visitVarInsn(Opcodes.ALOAD, 0);
        method.visitFieldInsn(
                Opcodes.GETFIELD,
                target.getInternalName(),
