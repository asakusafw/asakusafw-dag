...
public class OutputPatternSerDeGenerator {
    ...
    private List<PropertyReference> getProperties(DataModelReference reference, OutputPattern pattern) {
    ...
    private void putGetProperty(ClassWriter writer, DataModelReference reference, OutputPattern pattern) {
