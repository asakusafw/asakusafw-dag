...
public class ExtendOperatorGeneratorTest extends OperatorNodeGeneratorTestRoot {
    ...
    @Test
    public void cache() {
        CoreOperator opA = CoreOperator.builder(CoreOperatorKind.EXTEND)
                .input("in", Descriptions.typeOf(MockValueModel.class))
                .output("out", Descriptions.typeOf(MockDataModel.class))
                .build();
    ...
    public void cache_diff_type() {
        CoreOperator opA = CoreOperator.builder(CoreOperatorKind.EXTEND)
                ...
                .output("out", Descriptions.typeOf(MockDataModel.class))
                .build();
        CoreOperator opB = CoreOperator.builder(CoreOperatorKind.EXTEND)
                .input("in", Descriptions.typeOf(MockValueModel.class))
                .output("out", Descriptions.typeOf(MockKeyValueModel.class))
                .build();
        CoreOperator opC = CoreOperator.builder(CoreOperatorKind.EXTEND)
                .input("in", Descriptions.typeOf(MockKeyModel.class))
                .output("out", Descriptions.typeOf(MockDataModel.class))
                .build();
        NodeInfo a = generate(opA);
