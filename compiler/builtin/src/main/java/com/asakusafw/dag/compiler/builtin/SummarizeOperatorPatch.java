...
public class SummarizeOperatorPatch implements OperatorRewriter {
    ...
    private Operator patch(Context context, UserOperator operator) {
    ...
    private <T> void putAttribute(UserOperator.Builder target, UserOperator source, Class<T> attributeType) {
        target.attribute(attributeType, source.getAttribute(attributeType));
    }

    private Group rebuildInputGroup(Context context, OperatorInput input) {
