...
/**
 * An adapter for {@link DataTable}s.
 * Each implementation must have a constructor which only accepts {@link VertexProcessorContext}.
 */
public interface DataTableAdapter extends VertexElementAdapter {

    /**
     * Returns the available data table IDs.
     * @return the available data table IDs
     */
    Set<String> getIds();
     ...
     * @return the corresponded data table
     */
